...
class RezeptverwaltungTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('FkrezeptId', 'FknotizId', ),
        self::TYPE_CAMELNAME     => array('fkrezeptId', 'fknotizId', ),
        self::TYPE_COLNAME       => array(RezeptverwaltungTableMap::COL_FKREZEPT_ID, RezeptverwaltungTableMap::COL_FKNOTIZ_ID, ),
        self::TYPE_FIELDNAME     => array('fkrezept_id', 'fknotiz_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('FkrezeptId' => 0, 'FknotizId' => 1, ),
        self::TYPE_CAMELNAME     => array('fkrezeptId' => 0, 'fknotizId' => 1, ),
        self::TYPE_COLNAME       => array(RezeptverwaltungTableMap::COL_FKREZEPT_ID => 0, RezeptverwaltungTableMap::COL_FKNOTIZ_ID => 1, ),
        self::TYPE_FIELDNAME     => array('fkrezept_id' => 0, 'fknotiz_id' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
