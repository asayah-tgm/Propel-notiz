...
class PersonTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Personname', 'Beschreibung', 'PersonId', ),
        self::TYPE_CAMELNAME     => array('personname', 'beschreibung', 'personId', ),
        self::TYPE_COLNAME       => array(PersonTableMap::COL_PERSONNAME, PersonTableMap::COL_BESCHREIBUNG, PersonTableMap::COL_PERSON_ID, ),
        self::TYPE_FIELDNAME     => array('personName', 'beschreibung', 'person_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Personname' => 0, 'Beschreibung' => 1, 'PersonId' => 2, ),
        self::TYPE_CAMELNAME     => array('personname' => 0, 'beschreibung' => 1, 'personId' => 2, ),
        self::TYPE_COLNAME       => array(PersonTableMap::COL_PERSONNAME => 0, PersonTableMap::COL_BESCHREIBUNG => 1, PersonTableMap::COL_PERSON_ID => 2, ),
        self::TYPE_FIELDNAME     => array('personName' => 0, 'beschreibung' => 1, 'person_id' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('beschreibung', 'Beschreibung', 'VARCHAR', false, 128, null);
